...
must_haves:
  truths:
    - "User accessing /api/geist/stats without authentication receives 401 Unauthorized"
    - "User accessing /api/contacts/create without authentication receives 401 Unauthorized"
