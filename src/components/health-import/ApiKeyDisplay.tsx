        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-white/5 text-white/80 font-medium hover:bg-white/10 transition-colors"
            >
              {copied ? (
                <>
            ...
            <button
              onClick={generateNewApiKey}
              disabled={isGenerating}
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-white/5 text-white/80 font-medium hover:bg-white/10 disabled:opacity-50 transition-colors"
            >
              {isGenerating ? (
                <>
                  <Loader2 className="w-4 h-4 animate-spin" />
