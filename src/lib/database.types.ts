...
export type FreelanceProjectStatus = 'planning' | 'active' | 'paused' | 'completed' | 'cancelled';
...
export type FreelanceInvoiceStatus = 'draft' | 'sent' | 'paid' | 'overdue' | 'cancelled';
