    ...
    <div className="min-h-screen p-4 md:p-6">
      ...
      <header className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-adaptive">Kontakte</h1>
            <p className="text-adaptive-muted text-sm">Beziehungen pflegen & XP sammeln</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            download
            className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 text-adaptive rounded-lg transition-colors"
      ...
      {stats && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          ...
          >
            ...
            <p className="text-2xl font-bold text-adaptive">{stats.total}</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-2xl font-bold text-adaptive">{stats.favorites}</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-2xl font-bold text-adaptive">{stats.needingAttention}</p>
          </motion.div>
        </div>
      )}
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        {viewMode === 'graph' && (
          <div className="flex items-center gap-2">
            <span className="text-adaptive-dim text-sm">Filter:</span>
              ...
              <button
                ...
                className={`px-2 py-1 rounded text-xs transition-colors ${
                  selectedCategory === null
                    ...
                    : 'bg-white/5 text-adaptive-muted hover:text-adaptive'
                }`}
              >
                Alle
              </button>
