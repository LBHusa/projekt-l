...
const settingsSections = [
  {
    title: 'Profil',
    description: 'Avatar, Name und Bio bearbeiten',
  ...
  {
    title: 'Quest-Einstellungen',
    description: 'Quest-Generierung anpassen',
  ...
  },
  {
    ...
    description: 'Exportiere alle deine Projekt L Daten',
